...
int getNthLargest(int arr[], int size, int n)
{

int parent,scope, ctr, *newArr= NULL, giveBack;
newArr = (int *) malloc(size* sizeof(int));
for(scope = size -1,ctr=0; scope >=0 && ctr < n; scope--)
{
